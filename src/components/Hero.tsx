...
export function Hero() {
  ...
  return (
    <section className={`hero weather-${weather.kind} time-${weather.period}${weather.loading ? ' weather-pending' : ''}`} id="top">
      ...
      <div className="island-scene" aria-label="一座宁静的海岛插画"><div className="hero-sun" aria-hidden="true" /><Moon /><div className="hill back"><i /><i /><i /></div><div className="hill front"><i /><i /></div><div className="tree t1"><i className="trunk" /><span className="crown"><b /><b /><b /></span></div><div className="tree t2"><i className="trunk" /><span className="crown"><b /><b /><b /></span></div><div className="tree t3"><i className="trunk" /><span className="crown"><b /><b /><b /></span></div><div className="house"><i className="roof" /><i className="chimney" /><span className="window left-window" /><span className="window right-window" /><b className="door" /></div><div className="river" /><div className="waves">⌁　⌁　⌁</div></div>
